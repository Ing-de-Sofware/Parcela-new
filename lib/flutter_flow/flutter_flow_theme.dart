...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3E3F59);
  late Color secondary = const Color(0xFF8285D9);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFBCBED0);
  late Color primaryText = const Color(0xFFF1F4F8);
  late Color secondaryText = const Color(0xFF3E3F59);
  late Color primaryBackground = const Color(0xFF3E3F59);
  late Color secondaryBackground = const Color(0xFFF1F4F8);
  late Color accent1 = const Color(0x4C3E3F59);
  late Color accent2 = const Color(0x4D9489F5);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFBCBED0);
  late Color primaryText = const Color(0xFF3E3F59);
  late Color secondaryText = const Color(0xFFF1F4F8);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFF3E3F59);
  late Color accent1 = const Color(0x4C3E3F59);
  late Color accent2 = const Color(0x4D9489F5);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFF1F4F8);
