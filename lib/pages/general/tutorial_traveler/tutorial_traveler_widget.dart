...
import 'tutorial_traveler_model.dart';
export 'tutorial_traveler_model.dart';

class TutorialTravelerWidget extends StatefulWidget {
  const TutorialTravelerWidget({super.key});

  static String routeName = 'Tutorial-Traveler';
  static String routePath = '/tutorialTraveler';

  @override
  State<TutorialTravelerWidget> createState() => _TutorialTravelerWidgetState();
}

class _TutorialTravelerWidgetState extends State<TutorialTravelerWidget>
    with TickerProviderStateMixin {
  late TutorialTravelerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TutorialTravelerModel());
