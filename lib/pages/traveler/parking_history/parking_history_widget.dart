...
import 'parking_history_model.dart';
export 'parking_history_model.dart';

class ParkingHistoryWidget extends StatefulWidget {
  const ParkingHistoryWidget({super.key});

  static String routeName = 'Parking-History';
  static String routePath = '/parkingHistory';

  @override
  State<ParkingHistoryWidget> createState() => _ParkingHistoryWidgetState();
}

class _ParkingHistoryWidgetState extends State<ParkingHistoryWidget> {
  late ParkingHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParkingHistoryModel());
  }
